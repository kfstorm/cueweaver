...
3/3, and C 2/2 runs produced 60/60 timestamp-aligned blocks.

Serialized prompt-character proxies for the canonical run were A 10,904, B
17,516, and C 19,471. These are prompt-size proxies, not provider token or
cost measurements.
...
Glossary learning has demonstrated an incremental quality benefit yet. Keep
Glossary terms provenance/confidence-aware, require ambiguity handling, and
track the PySubtrans 1.6.0 parser defect separately from the product decision.
