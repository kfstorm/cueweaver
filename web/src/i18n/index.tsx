  ...
  "zh-CN": withEnglishFallback(
    {
      ...
      "translate.configureDetail": "选择字幕来源，并选择要翻译成的语言。",
      ...
      "translate.targetLanguageHelp":
        "选择常用语言，或输入 BCP 47 代码，例如 zh-Hans、pt-BR 或 ja。",
      ...
      "jobs.jobs": "任务",
      "jobs.noJobs": "暂无任务",
      "jobs.noJobsDetail": "已提交的翻译会在这里显示其当前状态。",
      "jobs.startTranslation": "开始翻译",
      "jobs.loading": "正在加载任务",
      "jobs.loadingDetails": "正在加载任务详情",
      ...
      "termMaps.replaceJson": "替换全部 JSON 内容",
      "termMaps.replaceHelp":
        "这会删除当前所有映射，并用下方 JSON 完整替换，不会与现有内容合并。已创建的任务仍保留排队时使用的术语表内容。",
      "termMaps.replacementJson": "替换用 JSON 内容",
      "termMaps.replacing": "正在替换...",
      "termMaps.replaceContent": "替换内容",
      "termMaps.deleteTitle": "删除术语表",
      "termMaps.deleteHelp":
        "这会永久删除术语表，并清除使用它的目录默认值。不会删除 Media、Jobs 或已发布的字幕。输入“{name}”以确认。",
